...
# Call the API's channels.list method to list the existing channel country.
def list_channel_country(youtube, channel_id):
  results = youtube.channels().list(
    part='snippet',
    id=channel_id
  ).execute()
...
if __name__ == '__main__':
  ...
  try:
    if args.action == 'set':
      ...
      list_channel_country(youtube, args.channel_id)
    else:
